    ...
    <GeneralLayout>
      ...
      <section className='w-100'>
        <div className='w-100 mb-8 xl:mb-12 h-32 md:h-64 xl:h-80 relative bg-gray-900 rounded-lg bg-no-repeat inset-0 bg-opacity-30 bg-cover bg-center' style={{backgroundImage: "URL('/images/about/about_background.jpg')"}}>
          ...
          <div className='absolute text-sm md:text-base right-0 -bottom-12 xl:-bottom-14 bg-teal-600 text-white p-2 rounded-md'>Disponible para trabajar</div>
        </div>
        <div className='w-100 mt-16 xl:mt-24 flex gap-2 items-center'>
          ...
          <h3 className='text-gray-500 font-medium flex items-center text-base md:text-xl'><MdLocationOn className='fill-gray-500' /> Chile</h3>
        </div>
        <div className='w-100 mt-3 xl:mt-5 text-gray-500 flex gap-2 gap-y-3 flex-wrap justify-between'>
          <div className=' flex gap-2 flex-wrap gap-y-3 items-center w-100'>
            ...
            <h3 className='text-gray-900 font-semibold'>Ingeniero en Informática - Desarrollador web</h3>
          </div>
          <div className='flex gap-4'>
            <Link href={'/contact'} className='flex gap-1 items-center border-2 px-2 py-1 border-black text-black rounded-md'><FiMail /> Contactar</Link>
            <button className='flex gap-1 items-center border-2 px-2 py-1 border-black text-white bg-gray-900 rounded-md'> <FiDownloadCloud /> Descargar CV</button>
          </div>
        </div>
