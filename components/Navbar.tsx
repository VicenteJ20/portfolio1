...
export const Navbar = () => {
  ...
  return (
    <header className={` z-20 w-full py-4 mx-auto md:pt-3 flex flex-col md:flex-row transition transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); justify-start ${show ? 'h-full pt-20' : ' h-20'} md:h-fit  items-center px-3 md:px-10 gap-y-6 md:gap-y-1  md:justify-between bg-blend-darken fixed md:relative bg-white`}>
